...
output.textContent = `The second element withing the fourth element in myArray is ${myArray[3][1]}.`;
...
let orig6 = `Toronto Maple Leafs, Chicago Black Hawks, Detroit Red Wings, Boston Bruins, Montreal canadians, New York Rangers`;
...
orig6Array.splice(2, 2 , "Edmonton Oliers");
